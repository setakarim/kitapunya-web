...
class BarangCampaignTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('barang_campaign')->insert([
            ['max_qty' => 100, 'real_qty' => 10, 'barang_id' => 1, 'campaign_id' => 1, 'created_at' => Carbon::now()],
            ['max_qty' => 100, 'real_qty' => 10, 'barang_id' => 2, 'campaign_id' => 1, 'created_at' => Carbon::now()],
            ...
            ['max_qty' => 100, 'real_qty' => 15, 'barang_id' => 5, 'campaign_id' => 2, 'created_at' => Carbon::now()],
